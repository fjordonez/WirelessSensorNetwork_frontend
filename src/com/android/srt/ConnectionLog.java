...
public class ConnectionLog
{
	...
	private static final SimpleDateFormat TIMESTAMP_FMT = new SimpleDateFormat("[HH:mm:ss.SSS] ");

	public ConnectionLog() throws IOException
	{
		File sdcard = Environment.getExternalStorageDirectory();
        File logDir = new File(sdcard, "SRT/log/");
        if (!logDir.exists()) {
        	logDir.mkdirs();
		...
		open(logDir.getAbsolutePath() + "/TopicLog");
	}
	...
	{
		File f = new File(basePath + "-" + getTodayString()+ ".log");
